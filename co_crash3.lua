...
local co_crash3 = {
    identifier = "co_crash3",
    title = "Cosmic Ocean Crashes Due To Sliding Door Entering Loop",
    theme = THEME.COSMIC_OCEAN,
    floor_theme = THEME.JUNGLE,
    subtheme = THEME.VOLCANA,
    file_name = "co_crash3.lvl",
...
co_crash3.unload_level = function()
    if not level_state.loaded then return end
