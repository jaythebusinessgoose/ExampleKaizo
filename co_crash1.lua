...
local co_crash1 = {
    identifier = "co_crash1",
    title = "Cosmic Ocean Crashes Due To No Configured Size",
    theme = THEME.COSMIC_OCEAN,
    floor_theme = THEME.JUNGLE,
    subtheme = THEME.VOLCANA,
    file_name = "co_crash1.lvl",
}
...
co_crash1.unload_level = function()
    if not level_state.loaded then return end
